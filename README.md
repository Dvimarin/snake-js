...
<!-- TODO: 6. Добавить имя --> 
Этот проект был создан Неклюдовым Арсением в рамках обучения разработки веб-приложений.

<!-- TODO: 7. Добавить email --> 
Если у вас есть какие-либо вопросы или предложения, пожалуйста, свяжитесь со мной по адресу nekludovarsenij@gmail.com.